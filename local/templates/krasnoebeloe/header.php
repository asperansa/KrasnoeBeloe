...
<div class="over">
	<div class="he100">
        ...
        <a class="link-open" href="javascript:void(0);"><?= GetMessage('FEEDBACK_TITLE') ?><span></span></a>
	</div> <!--end menu-->
	<div class="all2">
		<div class="container-main"><a class="logo" href="/"><span></span></a>
	<div class="lang"><a href="#">in English</a></div>
	<div class="tel">
		<span><?= GetMessage('HELP_NAME'); ?></span>
        <div class="number">
            <? $APPLICATION->IncludeComponent(
                "bitrix:main.include",
                "",
